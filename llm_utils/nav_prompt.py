...
Your answer should be formatted as a dict, for example: Answer={'Reason':<Write one sentence in 10 words or fewer>, 'Angle':<Your Select Angle>, 'Flag':<Whether the target object is in your selected view, True or False>}.\
